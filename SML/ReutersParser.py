...
def obtain_topic_tags():
    ...
    """
    topics = open(
        "/home/jatsakthi/SML/classification/data/all-topics-strings.lc.txt", "r"
    ).readlines()
...
def train_svm(X, y):
    ...
    """
    svm = SVC(C=10.0, gamma='auto', kernel='rbf')
    svm.fit(X, y)
    return svm
...
if __name__ == "__main__":
    ...
    print "started"
    filename = "/home/jatsakthi/SML/classification/data/reut2-000.sgm"
